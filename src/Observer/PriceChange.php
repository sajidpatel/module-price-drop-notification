<?php
namespace MumzWorld\PriceDropNotification\Observer;
...
use MumzWorld\PriceDropNotification\Model\Queue\PriceDropNotificationPublisher;
use MumzWorld\PriceDropNotification\Model\PriceDropNotificationMessage;
